...
export function Icon({ name, size = 18, stroke = 1.75, color = 'currentColor', style = {} }) {
  const paths = {
    ...
    area: <><path d="M3 3h7v7H3z"/><path d="M3 3l18 18"/><path d="M14 14h7v7h-7z"/></>,
    ...
    whatsapp: <><path d="M21 11.5a8.38 8.38 0 0 1-8.5 8.5 8.5 8.5 0 0 1-3.8-.9L3 21l1.9-5.7a8.5 8.5 0 0 1-.9-3.8A8.38 8.38 0 0 1 12.5 3 8.5 8.5 0 0 1 21 11.5Z"/></>,
