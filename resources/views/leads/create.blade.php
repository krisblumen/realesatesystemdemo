    ...
    <section class="mx-auto max-w-[var(--container-content)] px-6 py-16">
        <div class="grid items-start gap-10 lg:grid-cols-[1.2fr_1fr]">
            ...
            <div class="flex flex-col gap-5">
                <a href="https://wa.me/524422722623?text={{ rawurlencode('¡Hola New Hauz! Vengo de su sitio web y me gustaría recibir asesoría sobre compra, venta o renta de un inmueble en Querétaro.') }}" target="_blank" rel="noopener"
                ...
                <div class="rounded-brand-lg border border-cloud bg-white p-6 shadow-sm">
                    <div class="flex flex-col gap-5">
                        @foreach ([
                            ...
                            ['Email', 'hola@newhauz.com.mx', 'M3 6h18v12H3z M3 7l9 6 9-6'],
