{{--
    El logotipo de WhatsApp, en un solo lugar.

    Lo usan el botón flotante del layout y cualquier CTA cuyo destino sea
    WhatsApp. Estaba escrito a mano en el layout; con dos usos, copiarlo habría
    dejado dos paths que se pueden desincronizar sin que nadie lo note.

    `fill="currentColor"` para que herede el color de quien lo contiene, y
    `aria-hidden` porque el texto del botón ya dice a dónde lleva.
--}}
@props(['class' => 'h-5 w-5'])
